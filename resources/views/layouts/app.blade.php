...
<head>
    ...
    <meta name="description" content="Sistem Informasi Akademik SMK Al - Falah">
    <meta name="author" content="SMK Al - Falah">
    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('assets/images/favicon.png')}}">
    <title>{{ config('app.name', 'Laravel')." V".env('APP_VERSION', '0')}}</title>
    <!-- Custom CSS -->
    ...
    <div id="main-wrapper">
                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{ asset('assets/images/favicon.png')}}" width="50" height="50" alt="homepage" class="light-logo" />
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer text-center">
                All Rights Reserved by SMK Al - Falah. Designed by <a href="https://wrappixel.com">WrapPixel</a>.
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
